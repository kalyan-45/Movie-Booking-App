...
class Confirmation extends Component {
  ...
  componentDidMount() {
    this.setState({
      totalPrice:
        ...
        this.props.location.bookingSummary.tickets.length,
    });
  }
  ...
  couponApplyClickHandler = () => {
    let tp = this.state.totalPrice * 0.9;
              ...
              <CardContent>
                ...
                <div className="coupon-container">
                  ...
                  <div className="marginApply">
                    <Button
                      variant="contained"
                      onClick={this.couponApplyClickHandler}
                      color="primary"
                    >
                      Apply
                    </Button>
          ...
          message={
            <span id="client-snackbar" className={classes.success}>
              <div className="confirm">
                ...
                <div className="msg">
                  {" "}
                  Booking Confirmed! Your booking reference number is{" "}
